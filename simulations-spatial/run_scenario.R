source("~/vecchiaFilter/simulations-spatial/data_generating_functions.R")
source("~/vecchiaFilter/simulations-spatial/data_generating_functions2.R")
...
create_scenario_tester = function(header, log_file_name){
  ...
  run_scenario = function(seed_r, domn, dimen, samp_size, neighbors, smth, mod_type, rnge, show_output = FALSE, run_algo= TRUE){
    ...
    for(i in 1:max_tries) {
      ...
      covmodel <- RandomFields::RMmatern(smth,var = 1,scale = rnge)
